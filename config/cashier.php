...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is the model that will be used as the customer for Cashier. By
    | default, Cashier assumes the App\Models\User model. However, if you
    | are using a different model for your billable entity, you should
    | specify it here.
    |
    */

    "customer" => App\Models\Team::class,
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Filament Cashier Plans
    |--------------------------------------------------------------------------
    |
    | Définissez ici vos plans pour Filament Cashier Billing Provider.
    | La clé est le nom du plan interne utilisé dans BillingProvider.
    | Chaque plan doit contenir l'ID du produit et du price Stripe.
    |
    */

    "plans" => [
        "default" => [
            "product_id" => "prod_TGVOnEVRHFHgAo",
            "price_id" => "price_1SJyUpFmp5cBhFaain0uOSSG",
        ],
    ],
];
