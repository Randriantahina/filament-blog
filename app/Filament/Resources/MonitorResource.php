...
class MonitorResource extends Resource
{
            ...
            ->schema([
                ...
                Forms\Components\Section::make('HTTP(s) Options')
                    ...
                    ->schema([
                        Forms\Components\TextInput::make('url')
                            ->label('URL')
                            ->required(fn (Forms\Get $get) => $get('type') === 'http')
                            ->maxLength(255),
                ...
                Forms\Components\Section::make('Port Options')
                    ...
                    ->schema([
                        Forms\Components\TextInput::make('url')
                            ...
                            ->required(fn (Forms\Get $get) => $get('type') === 'port')
                            ->maxLength(255),
                ...
                Forms\Components\Section::make('Keyword Options')
                    ...
                    ->schema([
                        Forms\Components\TextInput::make('url')
                            ->label('URL')
                            ->required(fn (Forms\Get $get) => $get('type') === 'keyword')
                            ->maxLength(255),
                        Forms\Components\TextInput::make('keyword')
                            ->label('Keyword')
                            ->required(fn (Forms\Get $get) => $get('type') === 'keyword')
                            ->maxLength(255),
                        Forms\Components\Toggle::make('keyword_case_sensitive')
                ...
                Forms\Components\Section::make('Heartbeat Options')
                    ...
                    ->schema([
                        Forms\Components\TextInput::make('heartbeat_grace_period_in_minutes')
                            ->label('Grace Period (minutes)')
                            ->required(fn (Forms\Get $get) => $get('type') === 'heartbeat')
                            ->numeric()
                            ->default(5),
                    ]),
            ]);
    ...
    {
        return [
            RelationManagers\CheckLogsRelationManager::class,
        ];
    }
